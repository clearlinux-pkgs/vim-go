...
Version  : 1.26
Release  : 22
URL      : https://github.com/fatih/vim-go/archive/v1.26/vim-go-1.26.tar.gz
Source0  : https://github.com/fatih/vim-go/archive/v1.26/vim-go-1.26.tar.gz
...
%prep
%setup -q -n vim-go-1.26
cd %{_builddir}/vim-go-1.26
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650845859
...
cp %{_builddir}/vim-go-1.26/LICENSE %{buildroot}/usr/share/package-licenses/vim-go/10a7a726771f1c426256febb7104f4620295cf74
