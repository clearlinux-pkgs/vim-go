...
Source0  : https://github.com/fatih/vim-go/archive/v1.28/vim-go-1.28.tar.gz
...
%prep
%setup -q -n vim-go-1.28
cd %{_builddir}/vim-go-1.28
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671475574
