...
Version  : 1.29
Release  : 24
URL      : https://github.com/fatih/vim-go/archive/v1.29/vim-go-1.29.tar.gz
Source0  : https://github.com/fatih/vim-go/archive/v1.29/vim-go-1.29.tar.gz
...
%prep
%setup -q -n vim-go-1.29
cd %{_builddir}/vim-go-1.29
%patch -P 1 -p1
pushd ..
cp -a vim-go-1.29 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745335320
...
cp %{_builddir}/vim-go-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/vim-go/10a7a726771f1c426256febb7104f4620295cf74 || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3 "-f" Makefile.clear
popd
GOAMD64=v2
...
/usr/share/vim/vimfiles/autoload/go/extract.vim
/usr/share/vim/vimfiles/autoload/go/extract_test.vim
...
/usr/share/vim/vimfiles/autoload/go/lsp/filechangetype.vim
...
/usr/share/vim/vimfiles/autoload/go/sameids.vim
...
/usr/share/vim/vimfiles/autoload/go/test-fixtures/lsp/fmt/multibyte.go
/usr/share/vim/vimfiles/autoload/go/test-fixtures/lsp/fmt/multibyte_golden.go
...
/usr/share/vim/vimfiles/autoload/go/test-fixtures/test/src/example/example.go
...
/usr/share/vim/vimfiles/ftplugin/godoc.vim
/usr/share/vim/vimfiles/ftplugin/godoc/commands.vim
/usr/share/vim/vimfiles/ftplugin/godoc/mappings.vim
...
/usr/share/vim/vimfiles/syntax/gowork.vim
